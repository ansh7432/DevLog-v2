    ...
    >
      ...
      >
        ...
        <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
           Typescript, React, Next, Remix and Tailwind CSS.
        </p>
      ...
      >
        ...
        />
        <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
        Docker, GIT, MongoDB, Postman, GCP
        </p>
...
const items = [
  ...
  },
  {
    title: (
      <span
        onClick={() => navigator.clipboard.writeText("anshsoni743@gmail.com")}
