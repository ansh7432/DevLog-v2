  ...
  return (
    <Card>
      ...
      <div className="flex flex-col items-center justify-center text-center mt-4">
        <CardTitle>Inkwell</CardTitle>
        <CardDescription>
          Full-stack story writing platform with user authentication, story creation, and publishing features. Built with React, Express, and MongoDB for seamless content management.
        </CardDescription>
        <div className="flex gap-3 mt-3">
          <a
            href="https://github.com/ansh7432/Inkwell-Backend"
            target="_blank"
          ...
          <a
            href="https://inkwell-story.netlify.app/"
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-full p-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 transition-all"
          >
